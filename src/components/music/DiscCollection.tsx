...
export default memo(function DiscCollection({
  ...
  return (
    <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto sm:shrink-0 pt-1.5 sm:pt-0 sm:pl-4 pr-1 sm:pr-6 border-t border-white/10 sm:border-t-0 sm:border-l border-white/15">
