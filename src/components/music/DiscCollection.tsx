...
export default memo(function DiscCollection({
  ...
  return (
    <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto sm:shrink-0 sm:pl-4 pr-2 sm:pr-6 sm:border-l border-white/15">
      <div className="flex items-center gap-3 xs:gap-3.5 sm:gap-4 overflow-x-auto py-3 sm:py-4 px-2.5 sm:px-3 max-w-none sm:max-w-[340px] scrollbar-none touch-pan-x snap-x snap-proximity">
        {songs.map((song) => {
