    ...
    <div className="flex-1 flex items-center justify-between gap-2 sm:gap-4 min-w-0 px-0.5 sm:px-1">
      ...
      <div className="flex-1 flex flex-col justify-center min-w-0 py-0.5">
        ...
        <div className="flex items-center justify-between gap-2 sm:gap-3 min-w-0">
          <h3 className="text-xs sm:text-sm font-headline font-bold text-white tracking-tight leading-tight truncate max-w-[130px] xs:max-w-[140px] sm:max-w-[220px]">
      ...
      <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
        <button
          ...
          className="w-6 h-6 sm:w-8 sm:h-8 rounded-full hover:bg-white/10 text-white/80 hover:text-white transition-colors flex items-center justify-center disabled:opacity-20"
        ...
        <button
          ...
          disabled={!currentSong}
          className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-amber-400 text-black hover:bg-amber-300 hover:scale-105 active:scale-95 disabled:opacity-20 shadow-[0_0_20px_rgba(245,158,11,0.55)] transition-all flex items-center justify-center font-bold shrink-0"
          aria-label={isPlaying ? "Pause" : "Play"}
        >
          {isPlaying ? (
            <Pause size={16} fill="black" strokeWidth={0} />
          ) : (
            <Play size={16} fill="black" strokeWidth={0} className="ml-0.5" />
          )}
        </button>
        ...
        <div className="flex items-center gap-1.5 sm:gap-1.5 pl-1.5 sm:pl-3 border-l border-white/15">
          <button
            onClick={() => {
              playButtonClickSound();
              onEject();
            ...
            disabled={!currentSong}
            className="hidden xs:flex w-6 h-6 sm:w-6.5 sm:h-6.5 rounded-full hover:bg-white/10 text-white/60 hover:text-white transition-colors items-center justify-center disabled:opacity-20"
            title="Eject CD"
          >
            <DiscAlbum size={14} strokeWidth={1.5} />
          </button>
          ...
          <div className="flex items-center gap-1 group/vol">
            <button
              ...
              className="w-6 h-6 sm:w-6.5 sm:h-6.5 rounded-full hover:bg-white/10 text-white/60 hover:text-white transition-colors flex items-center justify-center"
            ...
            <div
              className="hidden sm:flex relative w-8 sm:w-10 h-1 bg-white/20 rounded-full cursor-pointer select-none overflow-visible items-center group-hover/vol:w-12 transition-all duration-200"
          ...
          <button
            ...
            className={`w-6 h-6 sm:w-6.5 sm:h-6.5 rounded-full flex items-center justify-center transition-colors ${
              playlistOpen
